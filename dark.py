...
def generate_key(duration):
    ...
    return f"𝐁ᴧƊᵑ𝐀𐌼-{duration.upper()}-{random_part}"
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝐁ᴧƊᵑ𝐀𐌼 𝗯𝗼𝘁!", reply_markup=markup)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "⛔️ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @DarkDdosOwner"
        bot.reply_to(message, response)
...
def status_command(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "⛔️ 𝗬𝗼𝘂 𝗮𝗿𝗲 𝗻𝗼𝘁 𝗮𝗻 𝗮𝗱𝗺𝗶𝗻 @DarkDdosOwner.")
...
def upload_to_terminal(message):
    """Handle file upload to terminal for admins @DarkDdosOwner."""
    user_id = str(message.chat.id)
...
def add_user_command(message):
    if str(message.chat.id) not in admin_id:
        bot.reply_to(message, "⛔ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @DarkDdosOwner DM TO BUY @DarkDdosOwner")
        return
...
def show_modify_options(message):
    if str(message.chat.id) not in admin_id:
        bot.reply_to(message, "⛔ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @DarkDdosOwner")
        return
